...
class socketadapter(object):
    ...
    the JsonReader and JsonRpc class contracts.
...
#
# The JsonReader state machine invokes the event handler whenever it makes an
...
class JsonReader(object):
    def __init__(self):
        self.event = conveyor.event.Event('JsonReader.event')
